...
class TotalizationFragmentSex : Fragment() {
    ...
    fun drawGraph(){
        ...
        val sex_probability_sort = TotalizationCloudFirestoreHelper.sex_probability.toList().sortedByDescending { (_, value) -> value}.toMap()
        var i = 0
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        Log.w( "DEBUG_DATA", "TotalizationFragmentSex onCreateView" );
